#!/usr/bin/env bash
# Install MAGIC VLSI on macOS, linked to Tcl/Tk 8.6 (Aqua).
...
# Tk 8.6 (formula name differs across taps)
...
[ -n "$TK86_PREFIX" ] || fail "Could not find a Tcl/Tk **8.6** keg. Try: brew reinstall tcl-tk@8"
...
# Add wish8.6 hint to activate (for Aqua GUI launcher)
...
Or, if your shell sources $PREFIX/activate:
